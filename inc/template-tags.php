...
function world_transport_intl_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Noticias anteriores', 'world-transport-intl' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Noticias más recientes <span class="meta-nav">&rarr;</span>', 'world-transport-intl' ) ); ?></div>
			<?php endif; ?>
